...
INSERT INTO users (email, password_hash, first_name, last_name, role) VALUES
                                                                          ...
                                                                          ('customer@example.com', '$2a$10$dummyhash', 'John', 'Doe', 'CUSTOMER')
    ON CONFLICT (email) DO NOTHING;

INSERT INTO products (name, description, price, category, sub_category, brand, size, color, gender, stock_quantity, image_url) VALUES
                                                                                                                                   ...
                                                                                                                                   ('Athletic Shorts', 'Breathable athletic shorts', 39.99, 'BOTTOMS', 'SHORTS', 'SportGear', 'M', 'Gray', 'MEN', 75, 'https://example.com/shorts1.jpg')
